...
Lose::Lose(GameManager* manager) : GameState(manager) {
    ...
    TheTextureManager::Instance()->LoadText("font/lazy.ttf", "restart", lostTextColor, 60, "Press Space to Play New Level", restartTextSize);
    TheTextureManager::Instance()->LoadText("font/lazy.ttf", "retry", lostTextColor, 60, "Press Enter to Retry Current Level", restartTextSize);
}
